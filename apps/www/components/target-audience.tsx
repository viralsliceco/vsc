    ...
    <section id="entrepreneur" className="bg-black py-20 sm:py-24 lg:py-28">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 max-w-6xl mx-auto">
          ...
          <div className="relative flex flex-col justify-end items-center text-center p-10 min-h-[550px] rounded-2xl overflow-hidden border border-border">
            ...
            <div className="relative z-20 flex flex-col items-center gap-y-6">
              ...
              <p className="text-md text-text-secondary max-w-md">
                We help motivated{" "}
                <b className="font-bold text-text-primary">Entrepreneurs</b>{" "}
                make viral videos.
              </p>
              <Link href="/contact">
                <Button className="inline-flex items-center justify-center cursor-pointer rounded-2xl bg-primary px-8 py-4 text-base font-medium text-primary-foreground transition-colors hover:bg-primary/90">
          ...
          <div
            id="brand"
            className="relative flex flex-col justify-end items-center text-center p-10 min-h-[550px] rounded-2xl overflow-hidden border border-border"
          >
            <Image
            ...
            <div className="relative z-20 flex flex-col items-center gap-y-6">
              ...
              <p className="text-md text-text-secondary max-w-md">
                We integrate{" "}
                <b className="font-bold text-text-primary">Big Brands</b> into
